...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => {
  return (
    <div className="p-8 rounded-2xl bg-gray-800/50 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 group min-h-[300px]">
      {/* Increased padding from p-6 to p-8 and min height for bigger card */}
      <div className="mb-6">{icon}</div> {/* Slightly bigger margin */}
          ...
          <section className="container mx-auto px-4 pt-20 pb-32 text-center">
            ...
            <div className="flex justify-center items-center">
              <picture className="w-[30%] md:w-[30%] lg:w-[30%] floating-image">
                {/* Decreased width from 50%/75% to 30% */}
          ...
          <section id="features" className="py-24">
            <div className="container mx-auto px-4">
              <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
                {/* Increased gap between feature cards */}
                <FeatureCard
